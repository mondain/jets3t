...
public abstract class S3Service extends RestStorageService implements SignedUrlHandler {
     ...
     * the object's URL.
     */
    public String createUnsignedObjectUrl(String bucketName, String objectKey, boolean isVirtualHost, boolean isHttps, boolean isDnsBucketNamingDisabled) {
        // Create a signed GET URL then strip away the signature query components.
        String signedGETUrl = createSignedUrl("GET", bucketName, objectKey, null, null, 0, isVirtualHost, isHttps, isDnsBucketNamingDisabled);
     ...
     */
    public String createSignedUrlUsingSignatureVersion(String requestSignatureVersion, String region, String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, long secondsSinceEpoch, boolean isVirtualHost, boolean isHttps, boolean isDnsBucketNamingDisabled) {
        String s3Endpoint = this.getEndpoint();
        String uriPath;

        String hostname = (isVirtualHost ? bucketName : ServiceUtils.generateS3HostnameForBucket(bucketName, isDnsBucketNamingDisabled, s3Endpoint));
        ...
        if (getProviderCredentials() instanceof AWSDevPayCredentials) {
            ...
            uriPath += Constants.AMZ_SECURITY_TOKEN + "=" + RestUtils.encodeUrlString((String) headersMap.get(Constants.AMZ_SECURITY_TOKEN)) + "&";
        }
        ...
        if (specialParamName != null && specialParamName.toLowerCase().contains(Constants.REQUESTER_PAYS_BUCKET_FLAG)) {
        ...
        if (isHttps) {
            ...
            uriPrefix = "https://" + hostname + (httpsPort != 443 ? ":" + httpsPort : "") + serviceEndpointVirtualPath;
        } else {
            int httpPort = this.getHttpPort();
            uriPrefix = "http://" + hostname + (httpPort != 80 ? ":" + httpPort : "") + serviceEndpointVirtualPath;
        }
        ...
        if ("AWS4-HMAC-SHA256".equalsIgnoreCase(requestSignatureVersion)) {
            ...
            String timestampISO8601 = SignatureUtils.formatAwsFlavouredISO8601Date(now);
            ...
            for (String headerName : renamedHeadersMap.keySet()) {
                ...
                String value = renamedHeadersMap.get(headerName) == null ? "" : renamedHeadersMap.get(headerName).toString().trim();
                headersToSignMap.put(name, value);
            }
            // Signed headers must always include "host"
            headersToSignMap.put("host", hostname);

            String credential = accessKey + "/" + datestampISO8601 + "/" + region + "/" + service + "/aws4_request";

            String signedHeaders = ServiceUtils.join(headersToSignMap.keySet().toArray(), ";");

            uriPath += "X-Amz-Algorithm=" + requestSignatureVersion + "&X-Amz-Credential=" + credential + "&X-Amz-Date=" + timestampISO8601 + "&X-Amz-Expires=" + secondsUntilExpiry + "&X-Amz-SignedHeaders=" + signedHeaders;

            // Canonical request string
            String canonicalRequestString;
            try {
                // Adjust hostname for specific regions
                URI uriWithCorrectedHostname = SignatureUtils.awsV4CorrectHostnameForRegion(new URI(uriPrefix), region);
                ...
                canonicalRequestString = SignatureUtils.awsV4BuildCanonicalRequestString(new URI(uriPrefix + "/" + uriPath), method, headersToSignMap, payloadSha256Hash);
            ...
            byte[] signingKey = SignatureUtils.awsV4BuildSigningKey(secretKey, timestampISO8601, region);
            ...
            String canonicalString = RestUtils.makeServiceCanonicalString(method, serviceEndpointVirtualPath + "/" + virtualBucketPath + uriPath, renameMetadataKeys(headersMap), String.valueOf(secondsSinceEpoch), this.getRestHeaderPrefix(), this.getResourceParameterNames());
            ...
            throw new RuntimeException("Unsupported value for request signature version \"" + requestSignatureVersion + "\", must be one of: " + "\"AWS2\" (legacy), \"AWS4-HMAC-SHA256\"");
        }
     ...
     * a URL signed in such a way as to grant access to an S3 resource to whoever uses it.
     */
    public String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, long secondsSinceEpoch, boolean isVirtualHost, boolean isHttps, boolean isDnsBucketNamingDisabled) {
        return createSignedUrlUsingSignatureVersion("AWS2", null, method, bucketName, objectKey, specialParamName, headersMap, secondsSinceEpoch, isVirtualHost, isHttps, isDnsBucketNamingDisabled);
    }
     ...
     * a URL signed in such a way as to grant access to an S3 resource to whoever uses it.
     */
    public String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, long secondsSinceEpoch, boolean isVirtualHost) {
        boolean isHttps = this.isHttpsOnly();
        boolean disableDnsBuckets = this.getDisableDnsBuckets();

        return createSignedUrl(method, bucketName, objectKey, specialParamName, headersMap, secondsSinceEpoch, isVirtualHost, isHttps, disableDnsBuckets);
    }
     ...
     * a URL signed in such a way as to grant access to an S3 resource to whoever uses it.
     */
    public String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, long secondsSinceEpoch) {
        return createSignedUrl(method, bucketName, objectKey, specialParamName, headersMap, secondsSinceEpoch, false);
    }
     ...
     */
    public String createSignedGetUrl(String bucketName, String objectKey, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("GET", bucketName, objectKey, null, null, secondsSinceEpoch, isVirtualHost);
    }
     ...
     */
    public String createSignedPutUrl(String bucketName, String objectKey, Map<String, Object> headersMap, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("PUT", bucketName, objectKey, null, headersMap, secondsSinceEpoch, isVirtualHost);
    }
     ...
     * a URL signed in such a way as to allow anyone to PUT an object into S3.
     */
    public String createSignedPutUrl(String bucketName, String objectKey, Map<String, Object> headersMap, Date expiryTime) {
     ...
     *         in S3.
     */
    public String createSignedDeleteUrl(String bucketName, String objectKey, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("DELETE", bucketName, objectKey, null, null, secondsSinceEpoch, isVirtualHost);
    }
     ...
     *         in S3.
     */
    public String createSignedDeleteUrl(String bucketName, String objectKey, Date expiryTime) {
     ...
     */
    public String createSignedHeadUrl(String bucketName, String objectKey, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("HEAD", bucketName, objectKey, null, null, secondsSinceEpoch, isVirtualHost);
    }
     ...
     *            starting with 'x-amz-'.
     * @param credentials
     *            the credentials of someone with sufficient privileges to grant
     ...
     */
    @Deprecated
    public static String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, ProviderCredentials credentials, long secondsSinceEpoch, boolean isVirtualHost, boolean isHttps, boolean isDnsBucketNamingDisabled) {
     ...
     */
    @Deprecated
    public String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, ProviderCredentials credentials, long secondsSinceEpoch, boolean isVirtualHost) {
        boolean isHttps = this.getHttpsOnly();
        boolean disableDnsBuckets = this.getDisableDnsBuckets();

        return createSignedUrl(method, bucketName, objectKey, specialParamName, headersMap, credentials, secondsSinceEpoch, isVirtualHost, isHttps, disableDnsBuckets);
    }
    ...
    public String createSignedUrl(String method, String bucketName, String objectKey, String specialParamName, Map<String, Object> headersMap, ProviderCredentials credentials, long secondsSinceEpoch) throws S3ServiceException {
        return createSignedUrl(method, bucketName, objectKey, specialParamName, headersMap, credentials, secondsSinceEpoch, false);
    }
     ...
     */
    @Deprecated
    public String createSignedGetUrl(String bucketName, String objectKey, ProviderCredentials credentials, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("GET", bucketName, objectKey, null, null, credentials, secondsSinceEpoch, isVirtualHost);
    }
     ...
     */
    @Deprecated
    public String createSignedPutUrl(String bucketName, String objectKey, Map<String, Object> headersMap, ProviderCredentials credentials, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("PUT", bucketName, objectKey, null, headersMap, credentials, secondsSinceEpoch, isVirtualHost);
    }
     ...
     */
    @Deprecated
    public String createSignedDeleteUrl(String bucketName, String objectKey, ProviderCredentials credentials, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("DELETE", bucketName, objectKey, null, null, credentials, secondsSinceEpoch, isVirtualHost);
    }
     ...
     */
    @Deprecated
    public String createSignedHeadUrl(String bucketName, String objectKey, ProviderCredentials credentials, Date expiryTime, boolean isVirtualHost) {
        long secondsSinceEpoch = expiryTime.getTime() / 1000;
        return createSignedUrl("HEAD", bucketName, objectKey, null, null, credentials, secondsSinceEpoch, isVirtualHost);
    }
     ...
     */
    @Deprecated
    public String createSignedHeadUrl(String bucketName, String objectKey, ProviderCredentials credentials, Date expiryTime) {
     ...
     *
     * @param operation
     *            the name of the test operation this condition statement will
     *            apply.
     * @param name
     ...
     *
     * @param name
     *            the name of the data item that will be allowed to take on any
     *            value.
     * @return a condition statement that can be included in the policy document
     *         belonging to an S3 POST form.
     */
     ...
     *
     * @param min
     *            the minimum number of bytes the user must upload. This value
     *            should be greater than or equal to zero.
     * @param max
     *            the maximum number of bytes the user can upload. This value
     ...
     *
     * @param bucketName
     *            the name of the target bucket to which the data will be
     *            uploaded.
     * @param key
     *            the key name for the object that will store the data. The key
     *            name can include the special variable <tt>${filename}</tt>
     *            which expands to the name of the file the user uploaded in the
     *            form.
     ...
     *            form.
     * @param credentials
     *            your Storage Provideer credentials. Credentials are only
     *            required if the form includes policy document conditions,
     *            otherwise this can be null.
     * @param expiration
     *            the expiration date beyond which the form will cease to work.
     *            If this parameter is null, the generated form will not include
     *            a policy document and will not have an expiry date.
     * @param conditions
     *            the policy conditions applied to the form, specified as policy
     *            document condition statements. These statements can be
     *            generated with the convenience method
     *            {@link #generatePostPolicyCondition(String, String, String)}
     *            and its siblings. If this parameter is null, the generated
     *            form will not include a policy document and will not apply any
     *            usage conditions.
     * @param inputFields
     *            optional input field strings that will be added to the form.
     *            Each string must be a valid HTML form input field definition,
     *            such as
     *            <tt>&lt;input type="hidden" name="acl" value="public-read"&gt;</tt>
     * @param textInput
     *            an optional input field definition that is used instead of the
     *            default file input field
     *            <tt>&lt;input name=\"file\" type=\"file\"&gt;</tt>. If this
     *            parameter is null, the default file input field will be used
     *            to allow file uploads. If this parameter is non-null, the
     *            provided string must define an input field named "file" that
     *            allows the user to provide input, such as
     *            <tt>&lt;textarea name="file" cols="60" rows="3"&gt;&lt;/textarea&gt;</tt>
     * @param isSecureHttp
     *            if this parameter is true the form will upload data to S3
     *            using HTTPS, otherwise it will use HTTP.
     * @return A form document that can be included in a UTF-8 encoded HTML web
    ...
    public static String buildPostForm(String bucketName, String key, ProviderCredentials credentials, Date expiration, String[] conditions, String[] inputFields, String textInput, boolean isSecureHttp) throws S3ServiceException, UnsupportedEncodingException {
        return buildPostForm(bucketName, key, credentials, expiration, conditions, inputFields, textInput, isSecureHttp, false, "Upload to Amazon S3");
    }
     ...
     *            form.
     * @param credentials
     *            your Storage Provider credentials. Credentials are only
     *            required if the form includes policy document conditions,
     *            otherwise this can be null.
     * @param expiration
     *            the expiration date beyond which the form will cease to work.
     ...
     *            if true the deprecated path style URL will be used to specify
     ...
     *            http://BUCKET_NAME.s3.amazon.com/. The path style can be
     *            useful for accessing US-based buckets with SSL, however non-US
     *            buckets are inaccessible with this style URL.
    ...
    public static String buildPostForm(String bucketName, String key, ProviderCredentials credentials, Date expiration, String[] conditions, String[] inputFields, String textInput, boolean isSecureHttp, boolean usePathStyleUrl, String submitButtonName) throws S3ServiceException, UnsupportedEncodingException {
        ...
        if (expiration != null || conditions != null) {
            ...
            // field
            String signature = ServiceUtils.signWithHmacSha1(credentials.getSecretKey(), policyB64);
        ...
        String url = null;
        if (usePathStyleUrl) {
            url = "http" + (isSecureHttp ? "s" : "") + "://s3.amazonaws.com/" + bucketName;
        } else {
            // Sub-domain URL style
            url = "http" + (isSecureHttp ? "s" : "") + "://" + bucketName + ".s3.amazonaws.com/";
        }
     ...
     *
     * @param bucket
     *            the bucket whose contents will be listed. This must be a valid
     ...
     *            S3Bucket object that is non-null and contains a name.
     * @param prefix
     *            only objects with a key that starts with this prefix will be
     *            listed
     * @param delimiter
     *            only list objects with key names up to this delimiter, may be
     *            null. See note above. <b>Note</b>: If a non-null delimiter is
     *            specified, the prefix must include enough text to reach the
    ...
    public S3Bucket createBucket(String bucketName) throws S3ServiceException {
        try {
            return this.createBucket(bucketName, getJetS3tProperties().getStringProperty("s3service.default-bucket-location", "US"), null);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
    ...
    public S3Bucket getOrCreateBucket(String bucketName) throws S3ServiceException {
        try {
            return this.getOrCreateBucket(bucketName, getJetS3tProperties().getStringProperty("s3service.default-bucket-location", "US"));
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     * @param location
     *            the location of the S3 data centre in which the bucket will be
     *            created, or null for the default
     *            {@link S3Bucket#LOCATION_US_STANDARD} location. Valid values
     *            include {@link S3Bucket#LOCATION_EUROPE},
     *            {@link S3Bucket#LOCATION_US_WEST},
     *            {@link S3Bucket#LOCATION_ASIA_PACIFIC}, and the default US
     *            location that can be expressed in two ways:
     *            {@link S3Bucket#LOCATION_US_STANDARD} or
     *            {@link S3Bucket#LOCATION_US}.
     * @param acl
     *            the access control settings to apply to the new bucket, or
     ...
     *
     * @param bucket
     *            the bucket containing the object. This must be a valid
     *            S3Bucket object that is non-null and contains a name.
     * @param objectKey
     ...
     *
     * @param versionId
     *            identifier matching an existing object version that will be
     *            retrieved.
     * @param bucketName
    ...
    public S3Object getVersionedObject(String versionId, String bucketName, String objectKey) throws S3ServiceException {
        try {
            ...
            return (S3Object) getObjectImpl(bucketName, objectKey, null, null, null, null, null, null, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
    ...
    public S3Object getVersionedObjectDetails(String versionId, String bucketName, String objectKey) throws S3ServiceException {
        try {
            ...
            return (S3Object) getObjectDetailsImpl(bucketName, objectKey, null, null, null, null, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     *            the maximum number of objects to include in each result
     *            message sent by S3. This value has <strong>no effect</strong>
     *            on the number of objects that will be returned by this method,
     *            because it will always return all the objects in the bucket.
     * @return the set of objects contained in a bucket whose keys start with
     *         the given prefix.
     * @throws S3ServiceException
     */
     ...
     *
     * @param bucketName
     *            the name of the the versioned bucket whose contents will be
     *            listed.
     * @param prefix
     *            only objects with a key that starts with this prefix will be
     *            listed
    ...
    public BaseVersionOrDeleteMarker[] getObjectVersions(String bucketName, String objectKey) throws S3ServiceException {
        BaseVersionOrDeleteMarker[] matchesForNamePrefix = listVersionedObjectsImpl(bucketName, objectKey, null, null, null, 1000);
     ...
     *
     * @param bucketName
     *            the name of the versioned bucket whose contents will be
     *            listed.
     * @param prefix
     *            only objects with a key that starts with this prefix will be
     *            listed
     ...
     * @param priorLastKey
     *            the last object key received in a prior call to this method.
     *            The next chunk of items listed will start with the next object
     *            in the bucket <b>after</b> this key name. This parameter may
     *            be null, in which case the listing will start at the beginning
     *            of the bucket's object contents.
     * @param priorLastVersionId
     *            the last version ID received in a prior call to this method.
     *            The next chunk of items listed will start with the next object
     *            version <b>after</b> this version. This parameter can only be
     *            used with a non-null priorLastKey.
     * @param completeListing
     *            if true, the service class will automatically perform
     *            follow-up requests to build a complete bucket object listing.
     * @return the set of objects contained in a bucket whose keys start with
     *         the given prefix.
     * @throws S3ServiceException
     */
    public VersionOrDeleteMarkersChunk listVersionedObjectsChunked(String bucketName, String prefix, String delimiter, long maxListingLength, String priorLastKey, String priorLastVersionId, boolean completeListing) throws S3ServiceException {
        return listVersionedObjectsChunkedImpl(bucketName, prefix, delimiter, maxListingLength, priorLastKey, priorLastVersionId, completeListing);
    }
     ...
     *
     * @param bucket
     *            an object representing the bucket to create which must be
     *            valid, and which may contain location and ACL settings that
     *            will be applied upon creation.
     ...
     * @param location
     *            the location of the S3 data centre in which the bucket will be
     *            created. Valid values include {@link S3Bucket#LOCATION_EUROPE}
     *            , {@link S3Bucket#LOCATION_US_WEST},
     *            {@link S3Bucket#LOCATION_ASIA_PACIFIC}, and the default US
     *            location that can be expressed in two ways:
     *            {@link S3Bucket#LOCATION_US_STANDARD} or
    ...
    public void enableBucketVersioningWithMFA(String bucketName, String multiFactorSerialNumber, String multiFactorAuthCode) throws S3ServiceException {
        updateBucketVersioningStatusImpl(bucketName, true, true, multiFactorSerialNumber, multiFactorAuthCode);
    }
    ...
    public void disableMFAForVersionedBucket(String bucketName, String multiFactorSerialNumber, String multiFactorAuthCode) throws S3ServiceException {
        updateBucketVersioningStatusImpl(bucketName, true, false, multiFactorSerialNumber, multiFactorAuthCode);
    }
     ...
     *
     * @param bucketName
     *            the name of the versioned bucket that will have versioning
     *            suspended.
     * @throws S3ServiceException
     */
    ...
    public void suspendBucketVersioningWithMFA(String bucketName, String multiFactorSerialNumber, String multiFactorAuthCode) throws S3ServiceException {
        updateBucketVersioningStatusImpl(bucketName, false, false, multiFactorSerialNumber, multiFactorAuthCode);
    }
     ...
     * @param object
     *            the object containing all information that will be written to
     *            S3. At very least this object must be valid. Beyond that it
     *            may contain: an input stream with the object's data content,
     ...
     *            possible, as this can remove the need to read data into memory
     ...
     *            the name of the versioned bucket that contains the original
     *            object.
     * @param sourceObjectKey
     *            the key name of the original object.
     * @param destinationBucketName
     *            the name of the destination bucket to which the object will be
     *            copied.
     * @param destinationObject
     *            the object that will be created by the copy operation. If this
     *            item includes an AccessControlList setting the copied object
     *            will be assigned that ACL, otherwise the copied object will be
     *            assigned the default private ACL setting.
     * @param replaceMetadata
     *            If this parameter is true, the copied object will be assigned
     *            the metadata values present in the destinationObject.
     *            Otherwise, the copied object will have the same metadata as
     *            the original object.
     * @param ifModifiedSince
     *            a precondition specifying a date after which the object must
     *            have been modified, ignored if null.
     * @param ifUnmodifiedSince
     *            a precondition specifying a date after which the object must
     *            not have been modified, ignored if null.
     * @param ifMatchTags
     *            a precondition specifying an MD5 hash the object must match,
     *            ignored if null.
     * @param ifNoneMatchTags
     *            a precondition specifying an MD5 hash the object must not
    ...
    public Map<String, Object> copyVersionedObject(String versionId, String sourceBucketName, String sourceObjectKey, String destinationBucketName, S3Object destinationObject, boolean replaceMetadata) throws S3ServiceException {
        return copyVersionedObject(versionId, sourceBucketName, sourceObjectKey, destinationBucketName, destinationObject, replaceMetadata, null, null, null, null);
    }
     ...
     *
     * @param bucket
     *            the bucket inside which the object will be put, which must be
     *            valid.
     * @param object
     *            the object containing all information that will be written to
     *            S3. At very least this object must be valid. Beyond that it
     ...
     *            a multi-factor authentication code generated by a device.
     * @param bucketName
     *            the name of the versioned bucket containing the object to be
     *            deleted.
     * @param objectKey
     *            the key representing the object in S3.
     * @throws S3ServiceException
    ...
    public void deleteVersionedObjectWithMFA(String versionId, String multiFactorSerialNumber, String multiFactorAuthCode, String bucketName, String objectKey) throws S3ServiceException {
        try {
            ...
            deleteObjectImpl(bucketName, objectKey, versionId, multiFactorSerialNumber, multiFactorAuthCode);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     *            deleted.
     * @param keys
     *            key names of objects to delete. both errors (if any) and a
     ...
     *            information about one or more objects to delete, including at
     *            least the object's key name and optionally the object's
     *            version. both errors (if any) and a list of object
     ...
     *            version.
     * @param isQuiet
     *            if true result will only include errors, if any. If false,
    ...
    public MultipleDeleteResult deleteMultipleObjectsWithMFA(String bucketName, ObjectKeyAndVersion[] objectNameAndVersions, String multiFactorSerialNumber, String multiFactorAuthCode, boolean isQuiet) throws S3ServiceException {
        return deleteMultipleObjectsWithMFAImpl(bucketName, objectNameAndVersions, multiFactorSerialNumber, multiFactorAuthCode, isQuiet);
    }
    ...
    public S3Object getObjectDetails(S3Bucket bucket, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags) throws S3ServiceException {
        try {
            ...
            return (S3Object) getObjectDetailsImpl(bucket.getName(), objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, null);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     * @param bucket
     *            the versioned bucket containing the object. This must be a
    ...
    public S3Object getVersionedObjectDetails(String versionId, S3Bucket bucket, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags) throws S3ServiceException {
        try {
            ...
            MxDelegate.getInstance().registerStorageObjectHeadEvent(bucket.getName(), objectKey);
            return (S3Object) getObjectDetailsImpl(bucket.getName(), objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
    ...
    public S3Object getVersionedObjectDetails(String versionId, String bucketName, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags) throws S3ServiceException {
        try {
            MxDelegate.getInstance().registerStorageObjectHeadEvent(bucketName, objectKey);
            return (S3Object) getObjectDetailsImpl(bucketName, objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     *            include only a portion of the object's data - starting at this
     *            point, ignored if null.
     * @param byteRangeEnd
     *            include only a portion of the object's data - ending at this
     *            point, ignored if null.
     * @return the object with the given key in S3, including only general
     *         details and metadata (not the data input stream)
     * @throws S3ServiceException
    ...
    public S3Object getObject(S3Bucket bucket, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags, Long byteRangeStart, Long byteRangeEnd) throws S3ServiceException {
        try {
            ...
            return (S3Object) getObjectImpl(bucket.getName(), objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, byteRangeStart, byteRangeEnd, null);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
    ...
    public S3Object getVersionedObject(String versionId, S3Bucket bucket, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags, Long byteRangeStart, Long byteRangeEnd) throws S3ServiceException {
        try {
            ...
            MxDelegate.getInstance().registerStorageObjectGetEvent(bucket.getName(), objectKey);
            return (S3Object) getObjectImpl(bucket.getName(), objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, byteRangeStart, byteRangeEnd, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
    ...
    public S3Object getVersionedObject(String versionId, String bucketName, String objectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags, Long byteRangeStart, Long byteRangeEnd) throws S3ServiceException {
        try {
            MxDelegate.getInstance().registerStorageObjectGetEvent(bucketName, objectKey);
            return (S3Object) getObjectImpl(bucketName, objectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, byteRangeStart, byteRangeEnd, versionId);
        } catch (ServiceException se) {
            throw new S3ServiceException(se);
        }
    }
     ...
     *
     * @param versionId
     *            the identifier of the object version whose ACL will be
     *            updated.
     * @param bucketName
     *            the name of the versioned bucket containing the object to
     *            modify.
     * @param objectKey
     *            the key name of the object to which ACL settings will be
     *            applied.
     * @param acl
     ...
     *
     * @param bucket
     *            the bucket whose ACL settings will be retrieved (if objectKey
     *            is null) or the bucket containing the object whose ACL
     *            settings will be retrieved (if objectKey is non-null).
     * @param objectKey
     *            if non-null, the key of the object whose ACL settings will be
     *            retrieved. Ignored if null.
     ...
     *            returned.
     * @param bucket
     *            the versioned bucket whose ACL settings will be retrieved (if
     *            objectKey is null) or the bucket containing the object whose
     ...
     *            returned.
     * @param bucketName
     *            the name of the versioned bucket containing the object whose
     *            ACL settings will be retrieved.
     * @param objectKey
     *            if non-null, the key of the object whose ACL settings will be
     *            retrieved. Ignored if null.
     * @return the ACL settings of the bucket or object.
     ...
     *            This must be a valid S3Bucket object that is non-null and
     *            contains a name.
     ...
     *
     * @param bucketName
     *            the name of the bucket whose logging status settings will be
     *            returned.
     ...
     *            if true, when logging is enabled the method will check the
     *            target bucket to ensure it has the necessary ACL permissions
     *            set to allow logging (that is, WRITE and READ_ACP for the
     *            group <tt>http://acs.amazonaws.com/groups/s3/LogDelivery</tt>
     *            ). If the target bucket does not have the correct permissions
     *            the bucket's ACL will be updated to have the correct
     *            permissions. If this parameter is false, no ACL checks or
     *            updates will occur.
     *
     * @throws S3ServiceException
     */
    public void setBucketLoggingStatus(String bucketName, S3BucketLoggingStatus status, boolean updateTargetACLifRequired) throws S3ServiceException {
        try {
            if (status.isLoggingEnabled() && updateTargetACLifRequired) {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("Checking whether the target logging bucket '" + status.getTargetBucketName() + "' has the appropriate ACL settings");
                }
                ...
                for (GrantAndPermission gap : logBucketACL.getGrantAndPermissions()) {
                    if (groupIdentifier.equals(gap.getGrantee().getIdentifier())) {
                        ...
                        if (gap.getPermission().equals(Permission.PERMISSION_WRITE)) {
                            ...
                            if (log.isDebugEnabled()) {
                                log.debug("Target bucket '" + status.getTargetBucketName() + "' has ACL " + "permission " + Permission.PERMISSION_WRITE + " for group " + groupIdentifier);
                            }
                        } else if (gap.getPermission().equals(Permission.PERMISSION_READ_ACP)) {
                            isSetLoggingGroupReadACP = true;
                            if (log.isDebugEnabled()) {
                                log.debug("Target bucket '" + status.getTargetBucketName() + "' has ACL " + "permission " + Permission.PERMISSION_READ_ACP + " for group " + groupIdentifier);
                            }
                        }
                    }
                }
     ...
     *            JSON access control policy document
     * @throws S3ServiceException
     */
     ...
     *
     * @param bucketName
     *            the name of the bucket whose request payment configuration
     ...
     *
     * @param bucketName
     *            the name of the bucket to which the request payment
     *            configuration settings will be applied.
     * @param requesterPays
     *            if true, the bucket will be configured to be Requester Pays.
     *            If false, the bucket will be configured to be Owner pays (the
     ...
     * <li>Divide the object's underlying file into parts with size &lt;= the
     * given maximum part size</li>
     ...
     * {@link #multipartAbortUpload(MultipartUpload)} then throw the original
     * exception</li>
     * </ol>
     ...
     * @param object
     *            a file-based object containing all information that will be
     *            written to the service. If the object provided is not
     *            file-based -- i.e. it returns null from
     *            {@link StorageObject#getDataInputFile()} -- an exception will
     *            be thrown immediately.
     * @param maxPartSize
     *            the maximum size in bytes for any single upload part. If the
     *            given object's data is less than this value it will be
    ...
    public void putObjectMaybeAsMultipart(String bucketName, StorageObject object, long maxPartSize) throws ServiceException {
        ...
        if (!multipartUtils.isFileLargerThanMaxPartSize(object.getDataInputFile())) {
            ...
            // Start upload
            MultipartUpload upload = multipartStartUpload(bucketName, object.getKey(), object.getMetadataMap(), object.getAcl(), object.getStorageClass());
            ...
            try {
                ...
                // Apply non-canned ACL settings if necessary (canned ACL will
                // already be applied)
                if (object.getAcl() != null && object.getAcl().getValueForRESTHeaderACL() == null) {
                    if (log.isDebugEnabled()) {
                        log.debug("Completed multipart upload for object with a non-canned ACL" + " so an extra ACL Put is required");
                    }
     ...
     *            NOTE: non-canned ACLs cannot be applied at the start of
     *            multipart uploads, and must be applied to the object after it
     *            has been completed.
     * @param storageClass
    ...
    public MultipartUpload multipartStartUpload(String bucketName, String objectKey, Map<String, Object> metadata, AccessControlList acl, String storageClass) throws S3ServiceException {
        return multipartStartUploadImpl(bucketName, objectKey, metadata, acl, storageClass, null);
    }
     ...
     *            the name of the bucket in which the object will be stored.
     * @param object
     *            object containing details to apply to the completed object,
    ...
    public MultipartUpload multipartStartUpload(String bucketName, S3Object object) throws S3ServiceException {
        return multipartStartUploadImpl(bucketName, object.getKey(), object.getMetadataMap(), object.getAcl(), object.getStorageClass(), object.getServerSideEncryptionAlgorithm());
    }
    ...
    public List<MultipartUpload> multipartListUploads(String bucketName, String nextKeyMarker, String nextUploadIdMarker, Integer maxUploads) throws S3ServiceException {
        return multipartListUploads(bucketName, null, null, nextKeyMarker, nextUploadIdMarker, maxUploads);
    }
     ...
     *            the delimiter (e.g. '/')
     * @param nextKeyMarker
     *            marker indicating where this list subset should start by key
     *            name.
     * @param nextUploadIdMarker
     *            marker indicating where this list subset should start by
     *            upload ID.
     * @param maxUploads
    ...
    public List<MultipartUpload> multipartListUploads(String bucketName, String prefix, String delimiter, String nextKeyMarker, String nextUploadIdMarker, Integer maxUploads) throws S3ServiceException {
        ...
        MultipartUploadChunk result = multipartListUploadsChunkedImpl(bucketName, prefix, delimiter, nextKeyMarker, nextUploadIdMarker, maxUploads, true);
     ...
     *            maximum number of uploads to retrieve at a time.
     * @param completeListing
     *            true to go on listing as long as there are uploads to be
     *            retrieved
    ...
    public MultipartUploadChunk multipartListUploadsChunked(String bucketName, String prefix, String delimiter, String keyMarker, String uploadIdMarker, Integer maxUploads, boolean completeListing) throws S3ServiceException {
        return multipartListUploadsChunkedImpl(bucketName, prefix, delimiter, keyMarker, uploadIdMarker, maxUploads, completeListing);
    }
    ...
    public List<MultipartPart> multipartListParts(MultipartUpload upload) throws S3ServiceException {
        return multipartListPartsImpl(upload.getUploadId(), upload.getBucketName(), upload.getObjectKey());
    }
    ...
    public MultipartCompleted multipartCompleteUpload(MultipartUpload upload, List<MultipartPart> parts) throws S3ServiceException {
        return multipartCompleteUploadImpl(upload.getUploadId(), upload.getBucketName(), upload.getObjectKey(), parts);
    }
     ...
     * {@link #multipartCompleteUpload(MultipartUpload, List)} API operation,
     ...
     * @param partNumber
     *            the part's number; must be between 1 and 10,000 and must
     *            uniquely identify a given part and represent its order
     *            compared to all other parts. Part numbers need not be
     *            sequential.
     * @param object
     *            an object containing a input stream with data that will be
     ...
     *         {@link #multipartCompleteUpload(MultipartUpload, List)}.
     * @throws S3ServiceException
     */
    public MultipartPart multipartUploadPart(MultipartUpload upload, Integer partNumber, S3Object object) throws S3ServiceException {
        MultipartPart part = multipartUploadPartImpl(upload.getUploadId(), upload.getBucketName(), partNumber, object);
     ...
     *            the key name of the original object.
     * @param ifModifiedSince
     *            a precondition specifying a date after which the source object
     *            must have been modified, ignored if null.
     * @param ifUnmodifiedSince
     *            a precondition specifying a date after which the source object
     *            must not have been modified, ignored if null.
     * @param ifMatchTags
     *            a precondition specifying an MD5 hash the source object must
     *            match, ignored if null.
     * @param ifNoneMatchTags
     *            a precondition specifying an MD5 hash the source object must
     *            not match, ignored if null.
     * @param byteRangeStart
     *            include only a portion of the source object's data - starting
     *            at this point, ignored if null. Byte ranges may only be used
     *            for source objects larger than 5 GB.
     * @param byteRangeEnd
     *            include only a portion of the source object's data - ending at
     *            this point, ignored if null. Byte ranges may only be used for
     *            source objects larger than 5 GB.
     * @param versionId
    ...
    public MultipartPart multipartUploadPartCopy(MultipartUpload upload, Integer partNumber, String sourceBucketName, String sourceObjectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags, Long byteRangeStart, Long byteRangeEnd, String versionId) throws S3ServiceException {
        MultipartPart part = multipartUploadPartCopyImpl(upload.getUploadId(), upload.getBucketName(), upload.getObjectKey(), partNumber, sourceBucketName, sourceObjectKey, ifModifiedSince, ifUnmodifiedSince, ifMatchTags, ifNoneMatchTags, byteRangeStart, byteRangeEnd, versionId);
        upload.addMultipartPartToUploadedList(part);
        return part;
    }
    ...
    public MultipartPart multipartUploadPartCopy(MultipartUpload upload, Integer partNumber, String sourceBucketName, String sourceObjectKey, String versionId) throws S3ServiceException {
        MultipartPart part = multipartUploadPartCopyImpl(upload.getUploadId(), upload.getBucketName(), upload.getObjectKey(), partNumber, sourceBucketName, sourceObjectKey, null, null, null, null, null, null, versionId);
        upload.addMultipartPartToUploadedList(part);
        return part;
    }
    ...
    public MultipartPart multipartUploadPartCopy(MultipartUpload upload, Integer partNumber, String sourceBucketName, String sourceObjectKey) throws S3ServiceException {
        MultipartPart part = multipartUploadPartCopyImpl(upload.getUploadId(), upload.getBucketName(), upload.getObjectKey(), partNumber, sourceBucketName, sourceObjectKey, null, null, null, null, null, null, null);
        upload.addMultipartPartToUploadedList(part);
        return part;
    }
     ...
     * @throws S3ServiceException
     */
    public void setWebsiteConfig(String bucketName, S3WebsiteConfig config) throws S3ServiceException {
        try {
     ...
     * @throws S3ServiceException
     */
    public void setLifecycleConfig(String bucketName, LifecycleConfig config) throws S3ServiceException {
    ...
    protected abstract void setBucketPolicyImpl(String bucketName, String policyDocument) throws S3ServiceException;
    ...
    protected abstract void setRequesterPaysBucketImpl(String bucketName, boolean requesterPays) throws S3ServiceException;

    protected abstract boolean isRequesterPaysBucketImpl(String bucketName) throws S3ServiceException;

    protected abstract BaseVersionOrDeleteMarker[] listVersionedObjectsImpl(String bucketName, String prefix, String delimiter, String keyMarker, String versionMarker, long maxListingLength) throws S3ServiceException;
     ...
     * @throws S3ServiceException
     */
    protected abstract VersionOrDeleteMarkersChunk listVersionedObjectsChunkedImpl(String bucketName, String prefix, String delimiter, long maxListingLength, String priorLastKey, String priorLastVersion, boolean completeListing) throws S3ServiceException;

    protected abstract void updateBucketVersioningStatusImpl(String bucketName, boolean enabled, boolean multiFactorAuthDeleteEnabled, String multiFactorSerialNumber, String multiFactorAuthCode) throws S3ServiceException;

    protected abstract S3BucketVersioningStatus getBucketVersioningStatusImpl(String bucketName) throws S3ServiceException;

    protected abstract MultipartUpload multipartStartUploadImpl(String bucketName, String objectKey, Map<String, Object> metadata, AccessControlList acl, String storageClass, String serverSideEncryptionAlgorithm) throws S3ServiceException;

    protected abstract void multipartAbortUploadImpl(String uploadId, String bucketName, String objectKey) throws S3ServiceException;

    protected abstract MultipartUploadChunk multipartListUploadsChunkedImpl(String bucketName, String prefix, String delimiter, String keyMarker, String uploadIdMarker, Integer maxUploads, boolean completeListing) throws S3ServiceException;

    protected abstract List<MultipartPart> multipartListPartsImpl(String uploadId, String bucketName, String objectKey) throws S3ServiceException;

    protected abstract MultipartCompleted multipartCompleteUploadImpl(String uploadId, String bucketName, String objectKey, List<MultipartPart> parts) throws S3ServiceException;

    protected abstract MultipartPart multipartUploadPartImpl(String uploadId, String bucketName, Integer partNumber, S3Object object) throws S3ServiceException;

    protected abstract MultipartPart multipartUploadPartCopyImpl(String uploadId, String targetBucketName, String targetObjectKey, Integer partNumber, String sourceBucketName, String sourceObjectKey, Calendar ifModifiedSince, Calendar ifUnmodifiedSince, String[] ifMatchTags, String[] ifNoneMatchTags, Long byteRangeStart, Long byteRangeEnd, String versionId) throws S3ServiceException;

    protected abstract void setNotificationConfigImpl(String bucketName, NotificationConfig config) throws S3ServiceException;

    protected abstract NotificationConfig getNotificationConfigImpl(String bucketName) throws S3ServiceException;

    public abstract MultipleDeleteResult deleteMultipleObjectsWithMFAImpl(String bucketName, ObjectKeyAndVersion[] objectNameAndVersions, String multiFactorSerialNumber, String multiFactorAuthCode, boolean isQuiet) throws S3ServiceException;

    public abstract LifecycleConfig getLifecycleConfigImpl(String bucketName) throws S3ServiceException;

    public abstract void setLifecycleConfigImpl(String bucketName, LifecycleConfig config) throws S3ServiceException;

    public abstract void deleteLifecycleConfigImpl(String bucketName) throws S3ServiceException;

    public abstract CORSConfiguration getBucketCORSConfiguration(String bucketName) throws S3ServiceException;

    public abstract void setBucketCORSConfiguration(String bucketName, CORSConfiguration corsConfig) throws S3ServiceException;

    public abstract void deleteBucketCORSConfiguration(String bucketName) throws S3ServiceException;
}
